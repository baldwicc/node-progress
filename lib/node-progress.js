...
/**
 * Sets a new total for the active progress bar
 * 
 * @param {number} total The new total number of ticks to complete
 * @api public
 */
ProgressBar.prototype.setTotal = function (total) {
  if ('number' != typeof total) throw new Error('total required');
  this.total = total;
}
